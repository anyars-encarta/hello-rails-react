...
> Greetings Rails project with Webpack is a fun meet and greet project that uses both Rails backend and React with Webpack frontend. If you want to have endless greetings, here is your friend. The greeting display has been set up with a Timer and
